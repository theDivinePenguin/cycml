      ...
      <div className="px-5 py-3">
        ...
        <dl>
          {envRows(data.environmental).map((row) => (
            ...
            >
              <dt className="text-[13px] text-foreground/75 leading-tight">{row.k}</dt>
              <dd className="flex items-baseline gap-3">
                <span className="readout text-[13px] whitespace-nowrap">{row.v}</span>
                <span
                  className="w-[7.5rem] text-right text-[11px]"
